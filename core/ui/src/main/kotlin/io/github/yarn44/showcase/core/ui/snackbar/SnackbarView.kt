package io.github.yarn44.showcase.core.ui.snackbar
 ...
 * Auto-dismisses after 3 seconds. Respects EdgeToEdge via WindowInsets.safeDrawing.
 */
@Composable
fun SnackbarView(
        ...
        AnimatedVisibility(
            ...
            lastSnackbar?.let { snackbar ->
                Surface(
                    ...
                    Text(
                        text = snackbar.description.value,
